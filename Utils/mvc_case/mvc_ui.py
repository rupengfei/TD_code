...
from Utils.mvc_case import mvc_qt, mvc_model, mvc_delegate
import lib.uic
from Utils import scriptTool

# --+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
scriptPath = scriptTool.getScriptPath()
base_class, from_class = lib.uic.loadUiType(scriptPath+'/mvc_qt.ui')


# class MVCWindow(mvc_qt.Ui_MainWindow, QtWidgets.QMainWindow):
class MVCWindow(base_class, from_class):
    '''
    '''
    ...
    def __init__(self, parent=None):
        ...
        self.__table_model = mvc_model.MVC_table_model(self.tableView,
                                                       [['A2', 'B2', 'A3', 'B4'], ['B1', 'B2', 'B3', 'B4']])
